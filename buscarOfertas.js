...
async function run() {
  ...
  for (const oferta of brutas) {
    ...
    // precoInfo precisa existir ANTES daqui — o score usa ehMenorPreco dele.
    // (Esse é o bug que já apareceu antes: "Cannot access 'precoInfo' before
    // initialization". Se essa ordem mudar de novo, ele volta a quebrar.)
