...
//
// Isto é o ESQUELETO do robô que ficaria rodando 24h procurando ofertas.
// Ele já roda de verdade (o cron dispara sozinho), mas a função `buscarOfertas()`
// abaixo ainda não está ligada a nenhuma loja real — hoje ela só gera dados de
// exemplo, porque puxar ofertas de verdade exige UM destes caminhos (ver README):
//
